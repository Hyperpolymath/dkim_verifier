...
:experimental:
:url-github: https://github.com/hyperpolymath/RRecord-Verity
:url-gitlab: https://gitlab.com/hyperpolymath/RRecord-Verity
:url-bitbucket: https://bitbucket.org/hyperpolymath/RRecord-Verity
:url-codeberg: https://codeberg.org/hyperpolymath/RRecord-Verity

Thunderbird extension for comprehensive email record verification (DKIM, SPF, DMARC, MTA-STS, TLSA)
...
RRecord-Verity is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
